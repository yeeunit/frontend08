...
export default function FreeBoardPage(){
    ...
    const onClickGraphqlApi = async () => {
        ...
        if(name && password && title && contents){alert("게시물 등록이 완료되었습니다!"); //삭제 
    ...
    <Wrapper>
        ...
        <Contents>
            <Label>유튜브</Label>
            <iframe type="url" onChange={onChangeYoutubeUrl} placeholder="링크를 복사해주세요.">
            </iframe>
        </Contents>
        ...
        <ImageWrapper>
            ...
            <UploadButton>
            <Input type="file" onChange={onChangeImages} placeholder="+">
            </Input>
            </UploadButton>
