...
import { IBoardWriteProps, IMyVariables } from './BoardWriteComment.types'


export default function FreeBoardWrite(props: IBoardWriteProps){
    ...
    if (name && password && title && contents) {
      ...
      try {
        const result = await createBoard({
          ...
          const Variables: IVariables = { createBoardInput: String(router.query._id){
              writer: name,
                password: password,
                title: title,
                contents: contents
