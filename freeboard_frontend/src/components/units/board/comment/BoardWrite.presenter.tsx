...
import { IBoardWriteUIProps } from './BoardWriteComment.types'


export default function BoardWriteUI(props: IBoardWriteUIProps){
    return (

    <B.Body style={{ background: '#E9CFEC'}}>
    ...
    <B.Wrapper> 
        ...
        <B.NP>
            <B.NamePW>
                ...
                onChange={props.onChangeName} defaultValue={props.data?.fetchBoard.name}
                readOnly={!!props.data?.fetchBoard.name}>
                </B.Name>
        ...
        <B.Contents>
            ...
            placeholder="제목을 작성해 주세요." defaultValue={props.data?.fetchBoard.title}></B.Input> 
            <B.Error>{props.titleError}</B.Error>
        </B.Contents>

        <B.Contents>
            <B.Label>내용 *</B.Label>
            <B.Input type="text" onChange={props.onChangeContents} placeholder="내용을 작성해주세요." 
            defaultValue={props.data?.fetchBoard.contents}></B.Input> 
